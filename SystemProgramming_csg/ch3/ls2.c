...
void mode_to_letters(mode_t mode, char mode_str[]){
	...
	if(mode & S_IRGRP) mode_str[1] = 'r';
	if(mode & S_IWGRP) mode_str[1] = 'w';
	if(mode & S_IXGRP) mode_str[1] = 'x';

	if(mode & S_IROTH) mode_str[1] = 'r';
	if(mode & S_IWOTH) mode_str[1] = 'w';
	if(mode & S_IXOTH) mode_str[1] = 'x';
}
